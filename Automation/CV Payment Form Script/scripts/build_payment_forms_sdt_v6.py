...
# ===========================
EXCEL_PATH = r"App Data/ward_guardian_info.xlsx"  # DO NOT CHANGE IT PROGRAMMATICALLY
SHEET_NAME = 0  # first sheet
DATE_COLUMN = "visitdate"  # used to select the month
OUTPUT_DIR = r"App Data/Output/Payment Forms"
TEMPLATE_PATH = r"App Data/Templates/2025 Court Visitor Payment Invoice - fields.docx"  # put your local copy here
...
def main():
    ...
    for idx, page_records in enumerate(pages, start=1):
        ...
        # Auto-open the form for printing
        try:
            os.startfile(out_path)
            print(f"  Opened: {out_name}")
        except Exception as e:
            print(f"  Could not open {out_name}: {e}")
